...
func DiscordSetup(db *gorm.DB, validator *validator.Validate, sess *discordgo.Session, prefix string, selenium *configs.SeleniumConfig, cron *cron.Cron, caps selenium.Capabilities) routes.DiscordRoutes {
